...
```shell
yum -y install git wget && git clone https://github.com/ifkuan/v2board_install.git /usr/local/src/v2board_install && cd /usr/local/src/v2board_install && chmod +x v2board_install.sh && ./v2board_install.sh
```
...
![ok](https://cdn.jsdelivr.net/gh//tu/5a7f75412aa261c360c3bf340e9a7246.png)
